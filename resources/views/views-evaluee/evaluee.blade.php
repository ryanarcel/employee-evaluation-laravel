        ...
        <table class="table table-hover rounded" id="evalueeTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><a href="{{url('/evaluees/'.$evaluee->id)}}" class="btn btn-primary text-white"><i data-feather="eye"></i></a></td>
                    <td style="display:none">{{$evaluee->created_at}}</td>
                    <td class="text-center"><a href="{{url('/evaluees/'.$evaluee->id.'/edit')}}" class="btn btn-warning text-white"><i data-feather="edit-2"></i></a></td>
                    <td class="text-center">
                        <form action="{{route('evaluees.destroy', $evaluee->id)}}" method="post" onsubmit=" return confirmDelete();">
                            @csrf
                            @method('DELETE')
