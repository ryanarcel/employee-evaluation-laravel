    ...
    <div class="row">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form class="col-md-10 offset-md-1" id="form-updateItem" method="post">
                            ...
                            <a class="btn btn-warning" id="btn-delItem">Delete</a>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <form method="post" id="add_item" >
            ...
            <div class="form-group ml-4 mb-5">
                <label for="statement"><b>Create Statement</b></label>
                <textarea name="statement" id="statement" style="width:400px; height:100px; resize:none" class="form-control mb-2"></textarea>
