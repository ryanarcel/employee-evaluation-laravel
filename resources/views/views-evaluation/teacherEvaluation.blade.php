...
@section('content') 
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h5">Teacher Evaluation</h1>
    </div>
<div class="row">   
            ...
            <div class="card col-md-10 mb-3 shadow-sm card-evaluation" onmouseover="$(this).addClass('bg-gray').addClass('shadow')" onmouseout="$(this).removeClass('bg-gray').removeClass('shadow')">
                ...
                <div class="col pl-5 link-div">
                    ...
                    @if($evaluation->grant_access===0)
                        <a href="{{route('accessNot',['id'=>$evaluation->id, 'access'=>1, 'origin'=>'list'])}}" class="text-muted mr-2"><i data-feather="eye-off"></i> Hidden from teacher</a>
                    @else 
                        <a href="{{route('accessNot',['id'=>$evaluation->id, 'access'=>0, 'origin'=>'list'])}}" class="text-success mr-2"><i data-feather="eye"></i> Shown to teacher</a>
                    @endif
