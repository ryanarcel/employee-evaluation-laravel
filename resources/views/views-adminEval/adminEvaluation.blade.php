...
<style>
    *{padding:0;margin:0;}
    ...
    .float{
        ...
        bottom:40px; 
        right:40px;
        background-color:rgb(6, 233, 221);
        color:#FFF;
        border-radius:50px;
        text-align:center;
...
@section('content') 
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h5">Admin Evaluation</h1>
    </div>
<div class="row">   
            ...
            <div class="card col-md-10 mb-3 shadow-sm card-evaluation" onmouseover="$(this).addClass('bg-gray').addClass('shadow')" onmouseout="$(this).removeClass('bg-gray').removeClass('shadow')">
                ...
                <div class="col pl-5 link-div">
                    ...
                    @if($evaluation->status===0)
                        <a href="{{route('adminOpenClose',['id'=>$evaluation->id, 'status'=>1, 'origin'=>'list'])}}" class="text-muted mr-2" ><i data-feather="toggle-left"></i> Closed</a>
                    @else 
                        <a href="{{route('adminOpenClose',['id'=>$evaluation->id, 'status'=>0, 'origin'=>'list'])}}" class="text-success mr-2"><i data-feather="toggle-right"></i> Open</a>
                    @endif
                    <br>
    ...
    <div class="col-md-2 offset-md-1">
        <div class="card shadow" style="width: 100%; margin-top:80px" >
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item" ><a href="{{route('admins.index')}}" >View by name</a></li>
          </ul>
        </div>

        <a href="{{route('adminevaluations.create')}}" class="float">
