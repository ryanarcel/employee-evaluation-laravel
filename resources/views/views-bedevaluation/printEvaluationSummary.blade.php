...
<body>
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="font-italic">Evaluation for Basic Education Faculty School Year {{$evaluations[0]->SY_from}}-{{$evaluations[0]->SY_to}}</p>
        ...
        <thead>
            ...
            <tr>
                ...
                @foreach($evaluations as $evaluation)
                    <th class="text-center mr-5 bg-white endColumn"><b>{{$evaluation->course}} <br> Grade {{$evaluation->yrlevel}}<br>({{$evaluation->session}})</b></th>
                @endforeach
